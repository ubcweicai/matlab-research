...
for f in files:
    ...
    with open(f, 'r') as file:
        data = [eval(fps.strip('\r\n')[:-2]) for fps in file.readlines() if len(fps.strip('\r\n')) > 1]
...
amountList = ['1000', '2000', '4000', '8000', '10000', '16000', '24000', '32000', '36000', '48000']

fig = figure(title="Test Result", ylabel="Avg Fps")
xVals = ['Amount'] + amountList
yVals = [['ac', 'as', 'mainc', 'msemic', 'semic']] + [resultDict[amount] for amount in amountList]
