...
filename=[dropbox,'/Code/Java/GeneticResourceSimulation/newresults/genetic_result_network.csv'];
...
xlabel('Device Quantity'),ylabel('Average Network Cost');
